...
<body>
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1221014883643198"
     crossorigin="anonymous"></script>
<!-- ads -->
<ins class="adsbygoogle"
     style="display:block"
     data-ad-client="ca-pub-1221014883643198"
     data-ad-slot="3806746004"
     data-ad-format="auto"
...
<div class="hero-card">
    ...
    <div class="section" id="chats-assistentes">
        ...
        <div class="card-container">
            ...
            <div class="card">
                <h3>Jan AI</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Assistente de IA com foco em produtividade e automação de tarefas.' : '[English translation needed]'; ?></p>
    ...
    <div class="section" id="geracao-imagens">
        ...
        <div class="card-container">
            ...
            <div class="card">
                <h3>Leonardo AI</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Plataforma avançada para geração de imagens com foco em designers e artistas.' : '[English translation needed]'; ?></p>
    ...
    <div class="section" id="analise-dados">
        ...
        <div class="card-container">
            ...
            <div class="card">
                <h3>Einblick</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Ferramenta de análise de dados colaborativa que utiliza IA para sugerir insights.' : '[English translation needed]'; ?></p>
                <p><a href="https://www.einblick.ai" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>Octoparse</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Software para extração automatizada de dados da web (web scraping) com IA.' : '[English translation needed]'; ?></p>
                <p><a href="https://www.octoparse.com" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>Databricks AI</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Plataforma que combina engenharia de dados, análise e machine learning.' : '[English translation needed]'; ?></p>
                <p><a href="https://www.databricks.com" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>Seek AI</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'IA para análise de dados que permite consultas em linguagem natural e interpretação automática dos resultados.' : '[English translation needed]'; ?></p>
    ...
    <div class="section" id="gerenciamento-texto">
        ...
        <div class="card-container">
            <div class="card">
                <h3>Grammarly</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Assistente de escrita baseado em IA que corrige gramática, ortografia e sugere melhorias no estilo do texto.' : '[English translation needed]'; ?></p>
            ...
            <div class="card">
                ...
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Aplicativo que melhora a legibilidade dos textos, sugerindo ajustes na gramática e estrutura das frases.' : '[English translation needed]'; ?></p>
                <p><a href="https://hemingwayapp.com" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>ProWritingAid</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Software de análise de texto que detecta erros gramaticais, sugere melhorias no estilo e oferece estatísticas detalhadas.' : '[English translation needed]'; ?></p>
                <p><a href="https://prowritingaid.com" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>DeepL Write</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Assistente de escrita baseado em IA que aprimora gramática e estilo para textos em vários idiomas.' : '[English translation needed]'; ?></p>
                <p><a href="https://www.deepl.com/write" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>Sapling AI</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Assistente de escrita para empresas, com recursos de autocompletar e análise de tom para melhorar a comunicação.' : '[English translation needed]'; ?></p>
                <p><a href="https://sapling.ai" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>Jasper AI</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Gerador de conteúdo com IA que cria textos para blogs, marketing e redes sociais.' : '[English translation needed]'; ?></p>
                <p><a href="https://www.jasper.ai" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>Copy.ai</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Plataforma de geração de conteúdo para marketing, capaz de criar textos persuasivos e otimizados.' : '[English translation needed]'; ?></p>
                <p><a href="https://www.copy.ai" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>Writesonic</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'IA para criação de textos, incluindo posts de blog, descrições de produtos e anúncios.' : '[English translation needed]'; ?></p>
                <p><a href="https://writesonic.com" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>Rytr</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Ferramenta de escrita automatizada baseada em IA, ideal para copywriting e criação de conteúdo.' : '[English translation needed]'; ?></p>
                <p><a href="https://rytr.me" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>Sudowrite</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Assistente de escrita para escritores e romancistas, ajudando na criação de histórias e personagens.' : '[English translation needed]'; ?></p>
                <p><a href="https://www.sudowrite.com" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>Text Blaze</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Ferramenta de automação de escrita que permite criar templates inteligentes e atalhos para textos repetitivos.' : '[English translation needed]'; ?></p>
                <p><a href="https://blaze.today" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>AI21 Studio</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Ferramenta de leitura e análise de textos que resume documentos longos com IA.' : '[English translation needed]'; ?></p>
            ...
            <div class="card">
                ...
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Plataforma de reescrita de textos com IA, útil para evitar plágio e criar novas versões de conteúdos.' : '[English translation needed]'; ?></p>
                <p><a href="https://www.paraphraser.io" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>Article Forge</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Gerador de artigos automáticos com IA, criando textos otimizados para SEO.' : '[English translation needed]'; ?></p>
                <p><a href="https://www.articleforge.com" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>SummarizeBot</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Ferramenta de IA que resume artigos, documentos e textos longos de forma automática.' : '[English translation needed]'; ?></p>
                <p><a href="https://summarizebot.com" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>Frase.io</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Plataforma de otimização de conteúdo que usa IA para analisar tendências e sugerir melhorias para SEO.' : '[English translation needed]'; ?></p>
                <p><a href="https://www.frase.io" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>INK Editor</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Assistente de escrita com IA, especializado em SEO e copywriting para conteúdos otimizados.' : '[English translation needed]'; ?></p>
    ...
    <div class="section" id="design-imagens">
        ...
        <div class="card-container">
            <div class="card">
                <h3>Canva AI</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Ferramenta de design gráfico com recursos de IA para geração de imagens e layouts automáticos.' : '[English translation needed]'; ?></p>
                <p><a href="https://canva.com" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>Remove.bg</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Remove automaticamente o fundo de imagens com um clique, usando IA.' : '[English translation needed]'; ?></p>
                <p><a href="https://remove.bg" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>Let’s Enhance</h3>
                <p><?php echo $translations[$lang]['description']; ?> <?php echo $lang === 'pt' ? 'Melhora a qualidade de imagens de baixa resolução, aprimorando detalhes e removendo ruídos.' : '[English translation needed]'; ?></p>
                <p><a href="https://letsenhance.io" class="card-button" target="_blank"><?php echo $translations[$lang]['access_site']; ?></a></p>
            </div>
            <div class="card">
                <h3>Runway ML</h3>
                <p><a href="https://runwayml.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Ferramenta de edição de vídeo e imagem com recursos de IA, incluindo remoção de fundo e geração de efeitos especiais.</p>
            </div>
            <div class="card">
                <h3>Deep Dream Generator</h3>
                <p><a href="https://deepdreamgenerator.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Usa redes neurais para criar arte surrealista a partir de imagens enviadas pelo usuário.</p>
            </div>
        </div>
    </div>
    ...
    <div class="section" id="seguranca-privacidade">
        ...
        <div class="card-container">
            <div class="card">
                ...
                <p><a href="https://www.cloudflare.com/bot-management" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Protege sites contra bots maliciosos usando IA para identificar e bloquear tráfego suspeito.</p>
            </div>
            <div class="card">
                <h3>Norton Genie AI</h3>
                <p><a href="https://us.norton.com/genie" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Ferramenta de IA da Norton para detecção de phishing e links suspeitos.</p>
            </div>
            <div class="card">
                <h3>Bitdefender AI</h3>
                <p><a href="https://www.bitdefender.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Antivírus com IA que detecta e bloqueia ameaças avançadas.</p>
            </div>
            <div class="card">
                <h3>IBM Security QRadar</h3>
                <p><a href="https://www.ibm.com/security/qradar" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Plataforma de segurança que usa IA para detectar e responder a ameaças cibernéticas.</p>
            </div>
            <div class="card">
                <h3>Google Safe Browsing</h3>
                <p><a href="https://transparencyreport.google.com/safe-browsing" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Sistema de proteção contra phishing e malware que usa IA para detectar sites perigosos.</p>
            </div>
            <div class="card">
                <h3>McAfee AI</h3>
                <p><a href="https://www.mcafee.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Solução de segurança que usa IA para análise de ameaças em tempo real.</p>
            </div>
            <div class="card">
                <h3>Microsoft Defender AI</h3>
                <p><a href="https://www.microsoft.com/security/blog" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Ferramenta de IA para proteção contra ameaças cibernéticas avançadas.</p>
            </div>
            <div class="card">
                <h3>Trend Micro XDR</h3>
                <p><a href="https://www.trendmicro.com/en_us/business/products/detection-response/xdr.html" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Plataforma que usa IA para detectar e responder a ataques cibernéticos.</p>
            </div>
            <div class="card">
                <h3>ESET AI Security</h3>
                <p><a href="https://www.eset.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Antivírus com inteligência artificial para proteção contra ameaças desconhecidas.</p>
            </div>
            <div class="card">
                <h3>Tessian AI</h3>
                <p><a href="https://www.tessian.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Protege e-mails contra ataques de phishing e vazamento de dados usando IA.</p>
            </div>
            <div class="card">
                <h3>Dashlane AI</h3>
                <p><a href="https://www.dashlane.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Gerenciador de senhas com IA para detectar senhas fracas e gerar senhas seguras.</p>
            </div>
            <div class="card">
                <h3>1Password AI Watchtower</h3>
                <p><a href="https://1password.com/watchtower" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Monitora senhas vazadas e sugere melhorias na segurança.</p>
            </div>
            <div class="card">
                <h3>LastPass AI</h3>
                <p><a href="https://www.lastpass.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Avalia a segurança de senhas armazenadas e alerta sobre vulnerabilidades.</p>
            </div>
            <div class="card">
                <h3>ReCaptcha AI</h3>
                <p><a href="https://www.google.com/recaptcha/about" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Sistema de IA que protege sites contra bots e ataques automatizados.</p>
            </div>
            <div class="card">
                <h3>DuckDuckGo AI Privacy</h3>
                <p><a href="https://www.duckduckgo.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Navegador e extensão que bloqueia rastreamento e protege dados do usuário.</p>
            </div>
            <div class="card">
                <h3>Jumbo Privacy</h3>
                <p><a href="https://www.jumboprivacy.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Aplicativo de IA que analisa configurações de privacidade e protege dados pessoais.</p>
            </div>
            <div class="card">
                <h3>Kaspersky AI Security</h3>
                <p><a href="https://www.kaspersky.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Ferramenta de segurança baseada em IA para análise de ameaças cibernéticas.</p>
            </div>
            <div class="card">
                <h3>Apple Lockdown Mode AI</h3>
                <p><a href="https://support.apple.com/en-us/HT212650" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Modo de segurança avançado da Apple que protege contra ataques cibernéticos sofisticados.</p>
            </div>
            <div class="card">
                <h3>Anonymizer AI</h3>
                <p><a href="https://anonaddy.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Criação de e-mails anônimos para proteger a privacidade do usuário.</p>
            </div>
        </div>
    </div>
    ...
    <div class="section" id="ia-codigo">
        ...
        <div class="card-container">
            <div class="card">
                ...
                <p><a href="https://github.com/features/copilot" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Assistente de codificação baseado em IA que sugere trechos de código em tempo real.</p>
            </div>
            <div class="card">
                <h3>Tabnine</h3>
                <p><a href="https://www.tabnine.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Autocompletar avançado para programadores, suportando diversas linguagens.</p>
            </div>
            <div class="card">
                <h3>Codeium</h3>
                <p><a href="https://www.codeium.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Alternativa gratuita ao Copilot para sugestões de código baseadas em IA.</p>
            </div>
            <div class="card">
                <h3>Amazon CodeWhisperer</h3>
                <p><a href="https://aws.amazon.com/codewhisperer" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Assistente de codificação da AWS com suporte para diversas linguagens.</p>
            </div>
            <div class="card">
                <h3>Mutable AI</h3>
                <p><a href="https://www.mutable.ai" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: IA para acelerar a escrita e refatoração de código.</p>
            </div>
            <div class="card">
                <h3>Cogram</h3>
                <p><a href="https://www.cogram.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Assistente de codificação baseado em IA para Python e SQL.</p>
            </div>
            <div class="card">
                <h3>Sourcegraph Cody</h3>
                <p><a href="https://sourcegraph.com/cody" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Ferramenta de busca e compreensão de código baseada em IA.</p>
            </div>
            <div class="card">
                <h3>AskCodi</h3>
                <p><a href="https://www.askcodi.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: IA que auxilia na geração de código e explicação de trechos.</p>
            </div>
            <div class="card">
                <h3>CodeGeeX</h3>
                <p><a href="https://github.com/THUDM/CodeGeeX" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Modelo de IA para completar código em diversas linguagens.</p>
            </div>
            <div class="card">
                <h3>DeepCode</h3>
                <p><a href="https://snyk.io/deepcode-ai" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Ferramenta que analisa código e detecta vulnerabilidades com IA.</p>
            </div>
            <div class="card">
                <h3>CodeWP</h3>
                <p><a href="https://www.codewp.ai" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: IA para geração de código WordPress.</p>
            </div>
            <div class="card">
                <h3>Warp AI</h3>
                <p><a href="https://www.warp.dev" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Terminal inteligente que auxilia na execução de comandos.</p>
            </div>
            <div class="card">
                <h3>Ponicode</h3>
                <p><a href="https://www.ponicode.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: IA para geração automática de testes unitários.</p>
            </div>
            <div class="card">
                <h3>CodePal</h3>
                <p><a href="https://www.codepal.ai" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Gerador de código que interpreta prompts em linguagem natural.</p>
            </div>
            <div class="card">
                <h3>Refact AI</h3>
                <p><a href="https://www.smallcloud.ai/refact" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: IA para refatoração e limpeza de código.</p>
            </div>
            <div class="card">
                <h3>AutoRegex</h3>
                <p><a href="https://www.autoregex.xyz" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Converte linguagem natural em expressões regulares.</p>
            </div>
            <div class="card">
                <h3>Codiga</h3>
                <p><a href="https://www.codiga.io" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Assistente de codificação para detectar e corrigir erros automaticamente.</p>
            </div>
            <div class="card">
                <h3>GPT Engineer</h3>
                <p><a href="https://github.com/AntonOsika/gpt-engineer" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: IA que gera projetos inteiros a partir de descrições.</p>
            </div>
            <div class="card">
                <h3>CodeConvert</h3>
                <p><a href="https://www.codeconvert.ai" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Traduz código entre diferentes linguagens automaticamente.</p>
            </div>
            <div class="card">
                <h3>AI Code Mentor</h3>
                <p><a href="https://www.aicodementor.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Ajuda a depurar e melhorar código automaticamente.</p>
            </div>
        </div>
    </div>
    ...
    <div class="section" id="pesquisa-aprendizado">
        ...
        <div class="card-container">
            <div class="card">
                <h3>TensorFlow</h3>
                <p><a href="https://www.tensorflow.org" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Biblioteca open-source da Google para aprendizado de máquina e deep learning.</p>
            </div>
            <div class="card">
                <h3>PyTorch</h3>
                <p><a href="https://pytorch.org" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Framework poderoso para redes neurais e deep learning criado pela Meta.</p>
            </div>
            <div class="card">
                <h3>Scikit-Learn</h3>
                <p><a href="https://scikit-learn.org" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Biblioteca de aprendizado de máquina para Python com algoritmos prontos.</p>
            </div>
            <div class="card">
                <h3>Keras</h3>
                <p><a href="https://keras.io" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: API de alto nível para redes neurais baseada no TensorFlow.</p>
            </div>
            <div class="card">
                <h3>Hugging Face</h3>
                <p><a href="https://huggingface.co" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Biblioteca para NLP (Processamento de Linguagem Natural).</p>
            </div>
            <div class="card">
                <h3>Google Vertex AI</h3>
                <p><a href="https://cloud.google.com/vertex-ai" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Plataforma da Google para desenvolvimento de modelos de IA sem código.</p>
            </div>
            <div class="card">
                <h3>Amazon SageMaker</h3>
                <p><a href="https://aws.amazon.com/sagemaker" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Plataforma da AWS para desenvolvimento e treinamento de modelos de ML.</p>
            </div>
            <div class="card">
                <h3>Azure Machine Learning</h3>
                <p><a href="https://azure.microsoft.com/en-us/products/machine-learning" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Serviço da Microsoft para criar e implantar modelos de ML.</p>
            </div>
            <div class="card">
                <h3>JAX</h3>
                <p><a href="https://jax.readthedocs.io/en/latest" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Biblioteca da Google para computação numérica eficiente e aprendizado profundo.</p>
            </div>
            <div class="card">
                <h3>OpenAI Gym</h3>
                <p><a href="https://www.gymlibrary.dev" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Plataforma para desenvolver e testar algoritmos de aprendizado por reforço.</p>
            </div>
            <div class="card">
                <h3>MLflow</h3>
                <p><a href="https://mlflow.org" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Ferramenta open-source para gerenciar ciclos de vida de modelos de aprendizado de máquina.</p>
            </div>
            <div class="card">
                <h3>Google Colab</h3>
                <p><a href="https://colab.research.google.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Ambiente online gratuito para rodar notebooks Jupyter com suporte a GPU.</p>
            </div>
            <div class="card">
                <h3>FastAI</h3>
                <p><a href="https://www.fast.ai" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Biblioteca de aprendizado profundo de alto nível para Python baseada no PyTorch.</p>
            </div>
            <div class="card">
                <h3>DVC</h3>
                <p><a href="https://dvc.org" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Controle de versão para projetos de aprendizado de máquina.</p>
            </div>
            <div class="card">
                <h3>Ludwig</h3>
                <p><a href="https://ludwig.ai" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Framework de aprendizado de máquina da Uber sem necessidade de programação.</p>
            </div>
            <div class="card">
                <h3>H2O.ai</h3>
                <p><a href="https://www.h2o.ai" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Plataforma de AutoML para criar modelos de aprendizado de máquina sem código.</p>
            </div>
            <div class="card">
                <h3>Neptune.ai</h3>
                <p><a href="https://neptune.ai" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Ferramenta para rastrear experimentos e otimizar modelos de ML.</p>
            </div>
            <div class="card">
                <h3>Weights & Biases</h3>
                <p><a href="https://wandb.ai" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Plataforma para monitorar, treinar e analisar modelos de IA.</p>
            </div>
            <div class="card">
                <h3>Comet ML</h3>
                <p><a href="https://www.comet.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Plataforma para rastrear experimentos de aprendizado de máquina.</p>
            </div>
            <div class="card">
                <h3>RapidMiner</h3>
                <p><a href="https://rapidminer.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Plataforma de ciência de dados para análise preditiva e aprendizado de máquina.</p>
            </div>
            <div class="card">
                <h3>BigML</h3>
                <p><a href="https://bigml.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Plataforma de aprendizado de máquina baseada em nuvem com interface amigável.</p>
            </div>
            <div class="card">
                <h3>Orange3</h3>
                <p><a href="https://orangedatamining.com" class="card-button" target="_blank">Acessar Site</a></p>
                <p>Descrição: Ferramenta visual para análise de dados e aprendizado de máquina.</p>
            </div>
        </div>
    </div>
